...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apiInfo(apiInfo())
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.vastag.sb.controllers"))
				.paths(PathSelectors.any())
				.build();
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API Revisão spring boot",
				"Esta API é utilizada no curso de Spring Boot do prof. Nelio Alves", "Versão 2.0",
				"https://www.udemy.com/terms",
				new Contact("Rafael vastag", "github.com/rafaelvastag", "rgvastag@gmail.com"),
